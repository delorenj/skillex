...
6. Render Markdown and structured `DailyReport`; write both atomically.
...
Use shipped defaults as a configurable baseline. Operators may add or rename sections, but retain explicit coverage/freshness.
