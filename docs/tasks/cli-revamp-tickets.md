...
The [specification](../plan/cli-revamp.md) defines the retained behavior, new interfaces, defaults, and retirement gates. SKRILL-10's package foundation, SKRILL-11's canonical resolver, SKRILL-12's catalog commands, SKRILL-13's set and pack commands, SKRILL-14's activation reconciler, SKRILL-15's scope selection commands, SKRILL-16's diagnostics, SKRILL-17's offline vendoring, and SKRILL-8's Hermes profile projection are implemented and validated; see the [foundation evidence](../implementation/cli-node-foundation.md), [resolver evidence](../implementation/cli-manifest-resolution.md), [catalog evidence](../implementation/cli-catalog.md), [composition evidence](../implementation/cli-compositions.md), [reconciliation evidence](../implementation/cli-reconciliation.md), [selection evidence](../implementation/cli-selections.md), [diagnostic evidence](../implementation/cli-diagnostics.md), [vendoring evidence](../implementation/cli-vendoring.md), and [profile evidence](../implementation/cli-profiles.md). SKRILL-18 migration tooling and canonical catalog conversion are implemented (see [migration evidence](../implementation/cli-migration.md) and [catalog evidence](../implementation/cli-catalog-migration.md)). SKRILL-19 integration is in progress with component execution ticket [PJAN-127](https://plane.delo.sh/33god/projects/18a79832-00fb-4146-b054-d88528f9fef3/issues/54629e52-28a1-4e36-ac1f-05691aba7ee2); consumer cutover and Python retirement remain open. Dependencies are recorded as clickable issue links in each description; these are not native blocker relations.
