...
The [specification](../plan/cli-revamp.md) defines the retained behavior, new interfaces, defaults, and retirement gates. SKRILL-10's package foundation, SKRILL-11's canonical resolver, SKRILL-12's catalog commands, SKRILL-13's set and pack commands, SKRILL-14's activation reconciler, SKRILL-15's scope selection commands, and SKRILL-16's diagnostics are implemented and validated; see the [foundation evidence](../implementation/cli-node-foundation.md), [resolver evidence](../implementation/cli-manifest-resolution.md), [catalog evidence](../implementation/cli-catalog.md), [composition evidence](../implementation/cli-compositions.md), [reconciliation evidence](../implementation/cli-reconciliation.md), [selection evidence](../implementation/cli-selections.md), and [diagnostic evidence](../implementation/cli-diagnostics.md). The remaining stories are open. Dependencies are recorded as clickable issue links in each description; these are not native blocker relations.
